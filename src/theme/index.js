    ...
    select: (opts = {}) => {
      ...
      table: (opts = {color:'white', size: 'compact'}) => {
          ...
          return {
              ...
              sortIconIdeal: 'fa fa-bars text-tigGray-300 opacity-25',
              vars: {
                  color: colors,
                  size: sizes
              }
...
// import { Compositions, composeTheme } from "components/avl-components/src";
...
// // import {composeTheme} from "components/avl-components/src/dist/Themes/utils";
