...
const RisComp = ({ data, layer, risId }) => {
  ...
  React.useEffect(() => {
    ...
    falcor.get([
      ...
      ['conflation', 'ris', risId, 'data', layer.filters.year.value, ['pct_bins_reporting', 'pct_bins_reporting_am','pct_bins_reporting_pm','pct_bins_reporting_off']]
      )
  }, [falcor, risId]);

  const RisInfo = React.useMemo(() => {
    return  get(falcorCache, ["ris", risId, 'meta', layer.filters.year.value], {})
  }, [risId, falcorCache,]);
