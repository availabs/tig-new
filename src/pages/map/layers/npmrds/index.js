...
import {NpmrdsLayers, NpmrdsSources} from '../../map-styles/npmrds'

import {TrafficSignalsSources} from '../../map-styles/traffic_signals'

import {filters, setActiveLayer, updateLegend} from './filters'
...
class NPMRDSLayer extends LayerContainer {
    ...
    async download(setLoading) {
            ...
            if (feat.geometry.type === 'MultiLineString') {
                for (var i = 0; i < feat.geometry.coordinates.length; i++) {
                    var line = {
                        ...
                        geometry: {
                            'type': 'LineString',
                            'coordinates': feat.geometry.coordinates[i],
                        }
                    };
        ...
        return Promise.resolve(shpDownload(geojson,
            {
